(function(){
    ...
    startGame.addEventListener("click", function(){
        ...
        document.querySelector('body').className = `${gameData.backgrounds[Math.floor(Math.random()*2)]}`;
    ...
    function characterAttack(){
        ...
        attackBtn.className = 'lowopac';
        
        document.querySelector(`#${attacker}`).src = `images/${attacker}2.png`;

        setTimeout(function(){
            document.querySelector(`#${attacker}`).src = `images/${attacker}1.png`;
        }, 2000)
